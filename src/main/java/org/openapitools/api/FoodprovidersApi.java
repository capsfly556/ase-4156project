...
public interface FoodprovidersApi {
     ...
     * @return Food provider deleted successfully. (status code 204)
     *         or Food provider not found. (status code 404)
     */
    @Operation(
    ...
    default ResponseEntity<Void> foodprovidersFoodProviderIdDelete(
        @Parameter(name = "foodProviderId", description = "The unique identifier of the food provider.", required = true, in = ParameterIn.PATH) @PathVariable("foodProviderId") String foodProviderId
    ) {
     ...
     *
     * @param foodProviderId The unique identifier of the food provider. (required)
     * @return Food provider details retrieved successfully. (status code 200)
     *         or Food provider not found. (status code 404)
     */
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Food provider details retrieved successfully.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = FoodProvider.class))
            }),
            @ApiResponse(responseCode = "404", description = "Food provider not found.")
        }
    )
     ...
     * @return Food provider updated successfully. (status code 200)
     *         or Failed to update food provider. (status code 400)
     *         or Food provider not found. (status code 404)
     */
    @Operation(
    ...
    default ResponseEntity<Void> foodprovidersFoodProviderIdPut(
        @Parameter(name = "foodProviderId", description = "The unique identifier of the food provider.", required = true, in = ParameterIn.PATH) @PathVariable("foodProviderId") String foodProviderId,
        @Parameter(name = "FoodProvider", description = "Updated food provider object.", required = true) @Valid @RequestBody FoodProvider foodProvider
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
     ...
     *
     * @return Successfully retrieved food providers. (status code 200)
     *         or No food providers found. (status code 404)
     */
    @Operation(
        operationId = "foodprovidersGet",
        summary = "Retrieve a list of all food providers.",
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved food providers.", content = {
                @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = FoodProvider.class)))
            }),
     ...
     * @return Food provider added successfully. (status code 201)
     *         or Failed to add food provider. (status code 400)
     */
    @Operation(
    ...
    default ResponseEntity<Void> foodprovidersPost(
        @Parameter(name = "FoodProvider", description = "A new food provider object.", required = true) @Valid @RequestBody FoodProvider foodProvider
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
