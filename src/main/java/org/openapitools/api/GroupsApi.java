...
public interface GroupsApi {
     ...
     *
     * @return Successfully retrieved a list of all groups in the service. (status code 200)
     *         or No groups found in the service. (status code 404)
     */
    @Operation(
        operationId = "groupsGet",
        summary = "Retrieve a list of all groups in the service.",
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully retrieved a list of all groups in the service.", content = {
    ...
    default ResponseEntity<Void> groupsGroupIdDelete(
        @Parameter(name = "groupId", description = "The unique identifier of the group.", required = true, in = ParameterIn.PATH) @PathVariable("groupId") String groupId
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
     ...
     *
     * @param groupId The unique identifier of the group. (required)
     * @return Group details retrieved successfully. (status code 200)
     *         or Group not found. (status code 404)
     */
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Group details retrieved successfully.", content = {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "List of group orders retrieved successfully.", content = {
                @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = GroupOrderResponse.class)))
            })
        }
    )
    @RequestMapping(
     ...
     * @return Group order deleted successfully. (status code 204)
     *         or Group order not found. (status code 404)
     */
    @Operation(
    ...
    default ResponseEntity<Void> groupsGroupIdOrdersOrderIdDelete(
        @Parameter(name = "groupId", description = "The unique identifier of the group.", required = true, in = ParameterIn.PATH) @PathVariable("groupId") String groupId,
        @Parameter(name = "orderId", description = "The unique identifier of the order.", required = true, in = ParameterIn.PATH) @PathVariable("orderId") String orderId
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
     ...
     * @param groupId The unique identifier of the group. (required)
     * @param orderId The unique identifier of the order. (required)
     * @return Group order details retrieved successfully. (status code 200)
     *         or Group order not found. (status code 404)
     */
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Group order details retrieved successfully.", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = GroupOrderResponse.class))
            }),
            @ApiResponse(responseCode = "404", description = "Group order not found.")
        }
    )
     ...
     * @return Group order updated successfully. (status code 200)
     *         or Failed to update the group order. (status code 400)
     */
    @Operation(
    ...
    default ResponseEntity<Void> groupsGroupIdOrdersOrderIdPut(
        @Parameter(name = "groupId", description = "The unique identifier of the group.", required = true, in = ParameterIn.PATH) @PathVariable("groupId") String groupId,
        @Parameter(name = "orderId", description = "The unique identifier of the order.", required = true, in = ParameterIn.PATH) @PathVariable("orderId") String orderId,
        @Parameter(name = "GroupOrder", description = "", required = true) @Valid @RequestBody GroupOrder groupOrder
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    default ResponseEntity<Void> groupsGroupIdPut(
        @Parameter(name = "groupId", description = "The unique identifier of the group.", required = true, in = ParameterIn.PATH) @PathVariable("groupId") String groupId,
        @Parameter(name = "Group", description = "", required = true) @Valid @RequestBody Group group
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
     ...
     *
     * @param group Group object to add, must specify group name, participant IDs, groupOrder IDs, and administrator ID. (required)
     * @return Successfully added a new group. (status code 201)
     *         or Failed to add a new group. (status code 400)
     */
    @Operation(
    ...
    default ResponseEntity<Void> groupsPost(
        @Parameter(name = "Group", description = "Group object to add, must specify group name, participant IDs, groupOrder IDs, and administrator ID.", required = true) @Valid @RequestBody Group group
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
